...
- Four independent vehicle libraries automatically switch with the trip type and remember the user's choice for each category. Street includes Car, Truck/4x4, Street motorcycle, and a playful Clown car; Off Road includes Dirt bike, SxS, Quad ATV, Three-wheeler, and Truck/4x4; Snow includes Snowmobile, Snow bike, Snowcat, and Tracked SxS; Water includes Boat, Sea-Doo, Hovercraft, and Kayak. All 16 profiles have dedicated side, front, and rear artwork. Off Road uses a clear, mountain-free dirt scene, Water uses uninterrupted open water with no mountain shoreline, and Street and Snow use their matching scenes. Choose exactly two active gauges and use the dashboard footer arrows to switch the central instrument between them.
